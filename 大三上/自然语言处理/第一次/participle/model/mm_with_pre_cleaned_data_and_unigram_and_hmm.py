...
def process_segment(forward_trie, backward_trie, segment, unigram_counts, total_unigram_count, vocabulary_size):
    ...
    if contains_chinese(segment):
        # 获取前向和后向最大匹配的分词结果
        forward_seg = forward_max_match(forward_trie, segment,use_hmm=True)
        backward_seg = backward_max_match(backward_trie, segment,use_hmm=True)
...
if __name__ == "__main__":
    ...
    output_file = '../results/hmm_based_output.txt'  # 输出文件路径
